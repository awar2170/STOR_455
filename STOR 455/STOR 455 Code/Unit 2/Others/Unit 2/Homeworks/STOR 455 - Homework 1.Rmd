...
3)    The turtle in the ninth row of the _Turtles_ dataset has a mass of 325 grams. What does your model predict for this turtle's number of _Annuli_? What is the residual for this case?
```{r}
...
- Normality: The distribution is roughly normal based on the normal qq plot.  The normal qq plot tells us how close our data would fit a normally distributed pattern of similar data.  Our data tails off at the upper end, which may be something to look into later and to keep in mind. 
```{r}
plot(Annuli~Mass, data = turtles)
abline(mod1)
plot(mod1, 1:2)
...
Our predicted value is 3.987 less than the actual number of turtle annuli for the turtle with a mass of 325 grams. 
